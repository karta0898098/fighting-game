...
import { buildMageWeapon } from './weapon.ts';

export const modelConfig = { bulk: 1.84, weapon: 'staff', robe: true, skinKind: 'cloth', headgear: 'hat' };
...
export const buildWeapon = buildMageWeapon;
