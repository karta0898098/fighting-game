...
import { buildSummonerWeapon } from './weapon.ts';

export const modelConfig = { bulk: 1.92, weapon: 'summonorb', robe: true, skinKind: 'cloth', headgear: 'hood' };
...
export const buildWeapon = buildSummonerWeapon;
