...
import { buildBardWeapon } from './weapon.ts';

export const modelConfig = { bulk: 1.74, weapon: 'lute', skinKind: 'cloth', headgear: 'hat' };
...
export const buildWeapon = buildBardWeapon;
