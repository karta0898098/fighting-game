...
import { buildTankWeapon } from './weapon.ts';

export const modelConfig = { bulk: 3.0, weapon: 'shield', skinKind: 'metal', headgear: 'helm', pauldron: true };
...
export const buildWeapon = buildTankWeapon;
