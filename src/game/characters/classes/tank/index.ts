...
const data = {
    ...
    talent: {
      ...
      desc: '永久減免 12% 傷害。承受/造成傷害累積【怒氣】(脫戰衰減)：怒氣越高減傷最高 30%、反擊傷害最高 +35%；怒氣 ≥55 戰意沸騰，移動與攻速 +16% 貼身擾亂。守護壁壘額外蓄怒；大招釋放全部怒氣化身不動壁壘 (依怒氣量獲得護體與反射)。',
      dr: 0.12, drMax: 0.30, dmgMax: 0.35,
    ...
    skill1: { name: '守護壁壘', type: 'buff', shield: 280, cleanse: true, duration: 8, effect: { kind: 'reflect', duration: 8, factor: 0.35 }, manaCost: 25, cd: 10, color: '#dfe6e9', vfx: 'tank_shield', ally: { radius: 300, shield: 160, cleanse: true } },
