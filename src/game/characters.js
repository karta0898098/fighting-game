...
export const CHARACTERS = [
  ...
  },
  {
    ...
    skill1: { name: '烈焰吐息', type: 'projectile', dmg: 18, speed: 540, radius: 13, lifetime: 0.45, count: 5, spread: 0.32, knockback: 40, manaCost: 45, cd: 6, color: '#ff9f43', effect: { kind: 'burn', duration: 2, tick: 0.5, dmg: 8 }, freezeBonus: 1.6, vfx: 'mage_fireball' },
  ...
  },
  {
    ...
    skill1: { name: '貫穿箭', type: 'projectile', dmg: 60, speed: 920, radius: 14, lifetime: 0.9, pierce: true, knockback: 90, manaCost: 25, cd: 6, chargeMax: 5, color: '#7bed9f', vfx: 'archer_arrow' },
    skill2: { name: '寄生箭', type: 'projectile', dmg: 26, speed: 560, radius: 8, lifetime: 2.0, knockback: 40, manaCost: 30, cd: 9, color: '#1abc9c', effect: { kind: 'bleed', duration: 4, tick: 0.5, dmg: 11, moveMult: 2.2 }, vfx: 'archer_arrow' },
